      ...
      <AnimatePresence mode="wait">
        <Suspense fallback={<SpinnerFullPage />}>
          <Routes location={location} key={location.pathname}>
            ...
            />
            <Route path="/reports/revenue" element={ <ProtectedRoute element={RevenueReport} roles={["admin", "reporter"]} /> } />
            <Route path="/reports/pms" element={ <ProtectedRoute element={PMSReport} roles={["admin", "reporter"]} /> } />
            <Route
              path="/audit/log"
              element={
                <ProtectedRoute
