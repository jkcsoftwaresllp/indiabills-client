...
// PRODUCTS
export const ItemMetadata: types.Field<types.Item>[] = [
...
// SUPPLIER
export const SupplierMetadata: types.Field<types.Supplier>[] = [
    /* About */
...
// TRANSPORT
export const TransportMetadata: types.Field<types.Transport>[] = [
    /* BASIC INFO */
...
// OFFERS
export const OfferMetadata: types.Field<types.Offer>[] = [
    /* BASIC INFO */
...
// CUSTOMERS
export const CustomerMetadata: types.Field<types.Customer>[] = [
    /* ABOUT */
...
// USERS
export const UserMetadata: types.Field<types.User>[] = [
    // About User
...
// INVENTORY
export const InventoryItemsMetadata: types.Field<types.InventoryItem>[] = [
...
export const LocationMetadata: types.Field<types.Location>[] = [
...
export const BatchViewMetadata: types.Field<types.Batch>[] = [
...
export const WarehouseEntryMetadata: types.Field<types.Batch>[] = [
 ...
 export const OrganizationMetadata: types.Field<types.Organization>[] = [
