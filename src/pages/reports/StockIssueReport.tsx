...
const StockIssuesReport = () => {
  ...
  const renderStockIssuesChart = (data: StockIssuesData[]) => (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <ResponsiveContainer width="100%" height={400}>
        ...
        >
          ...
          <YAxis />
          <Tooltip
            formatter={(value: number) => formatToIndianCurrency(value)}
          />
          <Legend />
  ...
  const summaryCards = (data: StockIssuesData[]) => {
