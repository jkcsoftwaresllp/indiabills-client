...
interface HSNData {
  ...
  totalIntegratedTax: string;
  totalCentralTax: string;
  totalStateUTTax: string;
  totalCess: string;
}
...
const HSNReport = () => {
  ...
  const columnDefs = [
    {
      headerName: "S.No",
      valueGetter: (params) => {
        // Return empty for the summary row (last row)
  ...
  const formatExportRow = (row: HSNData, index: number) => [
    row.hsn,
    row.description,
    row.uqc,
    row.totalQuantity,
