...
const SubscriptionHistory = () => {
  ...
  return (
    <Box sx={{ py: 0 }}>
      <Box sx={{ mb: 2 }}>
        <Typography variant="h6" component="h1" sx={{ fontWeight: 800, mb: 0.3, letterSpacing: '-0.02em', fontSize: '1.35rem' }}>
          Subscription History
        </Typography>
        <Typography variant="body2" color="textSecondary" sx={{ fontWeight: 400, fontSize: '0.9rem' }}>
      ...
      {subscriptions.length === 0 ? (
        ...
        >
          <Typography variant="body2" color="textSecondary" sx={{ fontSize: '0.95rem' }}>
            No subscriptions found yet. Start by purchasing a plan to see your subscription history here.
          </Typography>
        </Card>
      ) : (
        <TableContainer 
        ...
        <DialogContent sx={{ py: 2 }}>
          {selectedSubscription && (
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5 }}>
              ...
              >
                <Typography variant="caption" color="textSecondary" sx={{ fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.06em' }}>
                  Plan Name
                </Typography>
                <Typography variant="body1" sx={{ fontWeight: 700, fontSize: '1.15rem', color: 'primary.main', mt: 0.5 }}>
              ...
              >
                ...
                <Typography variant="h5" sx={{ fontWeight: 900, color: 'primary.main', mt: 0.5, letterSpacing: '-0.02em' }}>
              ...
              >
                ...
                <Typography variant="body2" sx={{ fontWeight: 600, mt: 0.5, color: '#1e293b' }}>
              ...
              {selectedSubscription.razorpay_payment_id && (
                ...
                >
                  ...
                  <Typography variant="caption" sx={{ wordBreak: 'break-all', display: 'block', mt: 0.5, fontSize: '0.8rem' }}>
                    {selectedSubscription.razorpay_payment_id}
                  </Typography>
                </Box>
              )}
