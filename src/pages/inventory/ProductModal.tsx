...
import { subBatch } from "../../definitions/Types";
...
interface ProductModalProps {
  ...
  handleClose: () => void;
  products: Options[];
  handleAddProduct: (newItem: subBatch) => void;
  selectedProducts?: subBatch[];
  handleRemoveProduct?: (itemIdToRemove: string) => void;
}
...
const ProductModal: React.FC<ProductModalProps> = ({
  ...
  const handleProductChange = (event: any, newValue: Options | null) => {
