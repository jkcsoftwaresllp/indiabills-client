  ...
  const managerRoutes = [
    {
      ...
      icon: <CustomersIcon sx={{ fontSize: 48, color: '#3b82f6' }} />,
    ...
    },
    {
      ...
      icon: <InventoryIcon sx={{ fontSize: 48, color: '#10b981' }} />,
    ...
    },
    {
      ...
      icon: <ItemsIcon sx={{ fontSize: 48, color: '#f59e0b' }} />,
    ...
    },
    {
      ...
      icon: <SuppliersIcon sx={{ fontSize: 48, color: '#ef4444' }} />,
    ...
    },
    {
      ...
      icon: <OffersIcon sx={{ fontSize: 48, color: '#8b5cf6' }} />,
      path: '/manager/offers',
    ...
    },
    {
      ...
      icon: <TransportIcon sx={{ fontSize: 48, color: '#06b6d4' }} />,
