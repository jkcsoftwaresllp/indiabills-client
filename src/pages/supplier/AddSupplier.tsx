...
const AddSuppliers = () => {
	...
	const [formData, setFormData] = useState<Supplier>(initializeFormData(SupplierMetadata));
...
interface Props {
	...
	setFormData: React.Dispatch<React.SetStateAction<Supplier>>;
}
...
const OtherPage = React.memo(({ formData, handleChange }: Props) => {
	return (
		<MultiPageAnimate>
			<div className="p-8 flex flex-col items-center gap-8 idms-bg">
				<main className="grid grid-cols-2 gap-6">
